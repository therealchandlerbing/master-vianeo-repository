...
**Quality Checklist:**
- [ ] Team description is under 300 characters
...
### Market Context
[Additional market information not captured above]

### Strategic Importance
[Why this project matters beyond immediate metrics]
...
### Evidence Gaps
[What critical evidence is missing?]

---

## Red Flag Checklist
- [ ] All claims lack supporting numbers
- [ ] Problem statement is not solution-neutral
- [ ] No clear user/buyer distinction
- [ ] Market sizing is top-down only with no bottom-up validation
- [ ] No evidence of customer validation
- [ ] Team lacks relevant domain expertise
- [ ] Business model is unclear or unsustainable
- [ ] Character limits are significantly exceeded
...
## File Information
**File Name:** Executive_Brief_[ProjectName]_[YYYY-MM-DD].md
...
2. Verify evidence quality ratings
3. Address any red flags identified
4. Proceed to Step 2: 40Q Assessment (if applicable)
