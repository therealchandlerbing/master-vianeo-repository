...
## ⚠️ MANDATORY ATTACHMENTS - DO NOT PROCEED WITHOUT

Step 11 **requires** screenshots from the Vianeo platform to ensure entity consistency.

| View | 🔴 REQUIRED Attachment | What It Must Show |
|------|------------------------|-------------------|
| **View 1** | Screencapture of initial Vianeo **Features-Needs table** | All needs as column headers, all features as row labels |
| **View 2** | Screencapture of available **Means list** from Step 4 | All means names with differentiation status (heart icon) |

> **⚠️ WITHOUT THESE SCREENSHOTS:** The AI cannot ensure entity matching and may hallucinate needs, features, or means that don't exist in your platform data. This will cause data inconsistency across steps.

---

### View 1: Features-Needs Matrix

**Trigger:** Generated by default with the standard call

**🔴 REQUIRED - Screencapture of initial Vianeo Features-Needs table**
- Must show: All needs as column headers
- Must show: All features as row labels (if any exist)
- Screenshot must be **legible and complete**
- Attach to your AI message before executing

**Axis Constraints:**
- **Horizontal axis (columns):** Use EXACTLY the N needs shown in the screenshot, no more or less
- **Vertical axis (rows):** Use the N features shown; you MAY propose additional features but mark them clearly as "NEW"

**Guardrails:**
> **CRITICAL:**
> - Need statements must match Step 5 EXACTLY (60-char limit preserved)
> - Do NOT paraphrase, abbreviate, or combine needs
> - Do NOT add "inferred" or "implied" needs
> - Column count MUST equal need count from the screenshot

---

### View 2: Features-Means Matrix

**Trigger:** View 2 must be EXPLICITLY requested - it is NOT auto-generated with View 1

**Call Pattern for View 2:**
...
**🔴 REQUIRED - Screencapture of available Means list**
- Source: Step 4 output or Vianeo platform Means section
- Must show: All means names
- Must show: Differentiation status (heart icon = differentiating)
- Screenshot must be **legible and complete**
- Attach to your AI message before executing View 2

**Axis Constraints:**
- **Horizontal axis (columns):** Use ONLY the means shown in the screenshot
- **Vertical axis (rows):** Same features as View 1

**Guardrails:**
> **CRITICAL:**
> - Do NOT create new means
> - All means names must match the attached list EXACTLY
> - Preserve differentiation status from Step 4 (heart icon = differentiating)
> - Column count MUST equal means count from Step 4
